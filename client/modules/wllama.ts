...
export const wllamaModels: Readonly<Record<string, WllamaModel>> = {
  "smollm2-135m": {
    ...
    label: "SmolLM 2 135M",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-SmolLM2-135M-Instruct",
  ...
  "lfm2-350m": {
    ...createDefaultModelConfig(),
    label: "LFM2 350M",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-LFM2-350M",
    hfFilePath: "model.shard-00001-of-00004.gguf",
  ...
  "smollm2-360m": {
    ...createDefaultModelConfig(),
    label: "SmolLM 2 360M",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-SmolLM2-360M-Instruct",
  ...
  "qwen-3-0.6b": {
    ...createDefaultModelConfig(),
    label: "Qwen 3 0.6B",
    hfRepoId: "hitkalariya/gguf-sharded-UD-Q4_K_XL-Qwen3-0.6B",
    hfFilePath: "model.shard-00001-of-00004.gguf",
  ...
  "lfm2-700m": {
    ...createDefaultModelConfig(),
    label: "LFM2 700M",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-LFM2-700M",
  ...
  "lfm2-1.2b": {
    ...createDefaultModelConfig(),
    label: "LFM2 1.2B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-LFM2-1.2B",
  ...
  "granite-3.1-1b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-granite-3.1-1b-a400m-instruct",
  ...
  "llama-3.2-1b": {
    ...createDefaultModelConfig(),
    label: "Llama 3.2 1B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Llama-3.2-1B-Instruct",
    hfFilePath: "model.shard-00001-of-00004.gguf",
  ...
  "gemma-3-1b": {
    ...createDefaultModelConfig(),
    label: "Gemma 3 1B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-gemma-3-1b-it",
  ...
  "pints-1.5b": {
    ...createDefaultModelConfig(),
    label: "Pints 1.5B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-1.5-Pints-16K-v0.1",
  ...
  "olmo-2-0425-1b": {
    ...createDefaultModelConfig(),
    label: "OLMo 2 1B",
    hfRepoId: "hitkalariya/gguf-sharded-UD-Q4_K_XL-OLMo-2-0425-1B-Instruct",
    hfFilePath: "model.shard-00001-of-00006.gguf",
  ...
  "stablelm-2-zephyr-1.6b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-stablelm-2-zephyr-1.6b",
    hfFilePath: "model.shard-00001-of-00006.gguf",
  ...
  "smollm2-1.7b": {
    ...createDefaultModelConfig(),
    label: "SmolLM 2 1.7B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-SmolLM2-1.7B-Instruct",
  ...
  "falcon-3-1b": {
    ...createDefaultModelConfig(),
    label: "Falcon 3 1B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Falcon3-1B-Instruct",
    hfFilePath: "model.shard-00001-of-00005.gguf",
  ...
  "aceinstruct-1.5b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-AceInstruct-1.5B",
    hfFilePath: "model.shard-00001-of-00006.gguf",
  ...
  "deepseek-r1-distill-qwen-1.5b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-DeepSeek-R1-Distill-Qwen-1.5B",
    hfFilePath: "model.shard-00001-of-00006.gguf",
    fileSizeInMegabytes: 1070,
  },
  "internlm-2.5-1.8b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-internlm2_5-1_8b-chat",
  ...
  "qwen-3-1.7b": {
    ...createDefaultModelConfig(),
    label: "Qwen 3 1.7B",
    hfRepoId: "hitkalariya/gguf-sharded-UD-Q4_K_XL-Qwen3-1.7B",
    hfFilePath: "model.shard-00001-of-00005.gguf",
  ...
  "granite-3.3-2b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-granite-3.3-2b-instruct",
  ...
  "exaone-3.5-2.4b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-EXAONE-3.5-2.4B-Instruct",
    hfFilePath: "model.shard-00001-of-00008.gguf",
  ...
  "gemma-2-2b": {
    ...createDefaultModelConfig(),
    label: "Gemma 2 2B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-gemma-2-2b-it",
    hfFilePath: "model.shard-00001-of-00004.gguf",
  ...
  "megrez-3b": {
    ...createDefaultModelConfig(),
    label: "Megrez 3B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Megrez-3B-Instruct",
    hfFilePath: "model.shard-00001-of-00007.gguf",
  ...
  "smollm3-3b": {
    ...createDefaultModelConfig(),
    label: "SmolLM 3 3B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-SmolLM3-3B",
  ...
  "granite-3.1-3b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-granite-3.1-3b-a800m-instruct",
  ...
  "falcon-3-3b": {
    ...createDefaultModelConfig(),
    label: "Falcon 3 3B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Falcon3-3B-Instruct",
    hfFilePath: "model.shard-00001-of-00006.gguf",
  ...
  "llama-3.2-3b": {
    ...createDefaultModelConfig(),
    label: "Llama 3.2 3B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Llama-3.2-3B-Instruct",
    hfFilePath: "model.shard-00001-of-00007.gguf",
    fileSizeInMegabytes: 1930,
  },
  "phi-3.5-mini-3.8b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Phi-3.5-mini-instruct",
  ...
  "gemma-3-4b": {
    ...createDefaultModelConfig(),
    label: "Gemma 3 4B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-gemma-3-4b-it",
    hfFilePath: "model.shard-00001-of-00005.gguf",
  ...
  "polaris-4b-preview": {
    ...createDefaultModelConfig(),
    label: "Polaris 4B",
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Polaris-4B-Preview",
    hfFilePath: "model.shard-00001-of-00008.gguf",
    fileSizeInMegabytes: 2380,
  },
  "phi-4-mini-reasoning": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-UD-Q4_K_XL-Phi-4-mini-reasoning",
    hfFilePath: "model.shard-00001-of-00005.gguf",
  ...
  "llama-3.1-nemotron-nano-4b": {
    ...
    hfRepoId: "hitkalariya/gguf-sharded-Q4_K_S-Llama-3.1-Nemotron-Nano-4B-v1.1",
    hfFilePath: "model.shard-00001-of-00009.gguf",
